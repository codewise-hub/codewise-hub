    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {(courseData[user?.ageGroup as keyof typeof courseData] || []).map((course) => (
            <div key={course.id} className="dashboard-card hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              <div className="aspect-video bg-gradient-to-br from-blue-100 to-purple-100 rounded-lg mb-4 flex items-center justify-center">
                <div className="text-4xl">{course.title.split(' ')[0]}</div>
              </div>
              ...
              <div className="flex justify-between items-center mb-4">
                ...
                <span className="text-gray-500 text-xs">⏱️ {course.estimatedHours}h</span>
              </div>
              <div className="mb-4">
